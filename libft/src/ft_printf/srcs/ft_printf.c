...
/*   Updated: 2018/05/31 18:53:51 by sgarcia          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					ft_printf(const char *str, ...)
{
	...
	while (str[res.k])
	{
		if (str[res.k] == '{' && str[res.k + 1] && str[res.k + 1] == '-')
			res = put_syntax((char *)&str[res.k], res, ap);
		if (str[res.k] == '%')
		{
			res.k++;
